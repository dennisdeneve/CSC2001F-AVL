...
print("Creating the randomized subsets...")
...
print ("Random subsets have been created successfully")
...
with open ('Insert/oklist5000.txt', 'r') as newSub:
    count = 0
...
results = "Results for insert oklist5000"        
os.system('echo ' + results + ' >> resultsJ.txt')
os.system('echo ' + str(best) + ' >> resultsJ.txt')
os.system('echo ' + str(average) + ' >> resultsJ.txt')
os.system('echo ' + str(worst) + ' >> resultsJ.txt')

print ("Finally completed the entire script!!!")
